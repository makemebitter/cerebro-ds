...
Apart from the dependencies above, you also need to have GPDB 5.27 (for UDAF and CTQ), Spark 2.4.5 (for Cerebro-Spark), Cerebro 1.0.0 (for Cerebro-Spark and DA), TensorFlow 1.14.0 (for all), PyTorch 1.4.0 (for certain experiments), CUDA 10.0, cuDNN 7.4. Please refer their own installation guides.
